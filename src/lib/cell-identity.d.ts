 ...
 * ```
 */
export declare function canonicalCellHash(cell: NotebookCell): string;
/**
 ...
 * ```
 */
export declare function ensureCellId(cell: NotebookCell, index: number, notebookPath: string): string;
/**
 ...
 * ```
 */
export declare function migrateNotebookCellIds(notebook: Notebook, notebookPath: string): MigrationResult;
